...
describe('Testing subscription functionality', () => {
    ...
    it('Should display a resource on the page after sending subscription', () => {
        ...
        browser.waitUntil(() => {
            ...
            return isMy_Sensor;
        }, 5000, 'Expected MY_SENSOR to show up on page after 5s');
    });
    it('Should redirect you to monitoring data page', () => {
        var monitorDataButton = $('a.waves-effect.waves-light.btn.orange.darken-2.monitor-data');
    ...
    it('Should see a change in data', () => {
        ...
        request.post(`${isHttps == 'true' ? 'https' : 'http'}://${om2mhost}:${om2mport}/~/in-cse/in-name/MY_SENSOR/DATA`, {
            headers: {
                'content-type': 'application/json;ty=4',
                'x-m2m-origin': 'admin:admin'
            },
            body: JSON.stringify({"m2m:cin":{"cnf":"application/text","con":"{\"kWH\": \"9001\" }"}})
    ...
    it('Should delete MY_SENSOR', () => {
        ...
        }, 5000, 'Expected delete button to show up on page after 5s');
